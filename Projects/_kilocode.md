...
> **Local Path:** `C:/Users/asus/.kilocode`
...
## 📂 Key Architecture
- **Sub-Modules:** `globalStorage/`, `node_modules/`, `skills/`, `workspaceStorage/`
- **Artifacts:** `package-lock.json`, `package.json`, `secrets.json`

## 🚀 Developer Run & Next Steps
```bash
cd "C:/Users/asus/.kilocode"
npm run dev
```
