...
is_finished: false
tech_stack: ["Node.js"]
path: "C:/Users/asus/Documents/Projects/shashi_school_app/firebase/functions"
git_remote: "Local Only / Unpushed"
git_branch: ""
git_dirty: false
last_commit: ""
created_at: 2026-09-13
last_mapped: "2026-09-12 20:59:14"
tags:
  - project
  - project-unfinished
...
> **Local Path:** `C:/Users/asus/Documents/Projects/shashi_school_app/firebase/functions`
...
## 📂 Key Architecture
- **Sub-Modules:** `node_modules/`
- **Artifacts:** `index.js`, `package-lock.json`, `package.json`

## 🚀 Developer Run & Next Steps
```bash
cd "C:/Users/asus/Documents/Projects/shashi_school_app/firebase/functions"
npm run dev
```
...
- **Audited by:** `gemini` at `2026-09-12T20:59:14.407594+00:00`
- **Previous Score:** 15 -> **Upgraded Score:** 65/100
...
- **Workspace Diagnostics:**
  ...
  - Test Results: 0 passed, 1 failed (1 total, 5.03s)
