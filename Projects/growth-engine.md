...
is_finished: false
tech_stack: ["Python"]
path: "C:/Users/asus/.workbuddy-ai/skills/growth-engine"
git_remote: "Local Only / Unpushed"
git_branch: ""
git_dirty: false
last_commit: ""
created_at: 2026-09-13
last_mapped: "2026-09-12 20:59:39"
tags:
  - project
  - project-unfinished
...
> **Local Path:** `C:/Users/asus/.workbuddy-ai/skills/growth-engine`
...
## 📂 Key Architecture
- **Sub-Modules:** Flat
- **Artifacts:** `autogrowth-weekly-scorecard.py`, `experiment-engine.py`, `pacing-alert.py`, `requirements.txt`, `SKILL.md`, `_skillhub_meta.json`

## 🚀 Developer Run & Next Steps
```bash
cd "C:/Users/asus/.workbuddy-ai/skills/growth-engine"
python main.py
```
...
- **Audited by:** `gemini` at `2026-09-12T20:59:39.181164+00:00`
...
- **Workspace Diagnostics:**
  ...
  - Test Results: 2 passed, 0 failed (2 total, 0.9s)
