...
status: active
tech_stack: []
path: "C:/Users/asus/Desktop/Founder mode/guardian-eye"
...
> **Local Path:** `C:/Users/asus/Desktop/Founder mode/guardian-eye`
...
- **Sub-Modules:** `exec/`, `prd/`
- **Key Artifacts:** Standard layout

## 🚀 Execution & Developer Quickstart
```bash
cd "C:/Users/asus/Desktop/Founder mode/guardian-eye"
...
- **Audited by:** `deepseek-v4-pro` at `2026-09-14T11:12:01.150335+00:00`
...
- **Workspace Diagnostics:**
  ...
  - Code Files: 21
  - Tech Manifests: `None`
  - Syntax Valid: `True` (18/18 checked)
  - Tests Detected: `True` (unittest)
  - Test Results: 0 passed, 6 failed (6 total, 0.85s)
