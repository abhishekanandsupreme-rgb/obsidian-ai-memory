...
status: active
tech_stack: []
path: "C:/Users/asus/money-mission"
...
> **Local Path:** `C:/Users/asus/money-mission`
...
- **Sub-Modules:** `applications/`, `launch-packages/`, `offers/`, `outreach-drafts/`, `reports/`
- **Key Artifacts:** `auth-login-output.log`, `auth-manual-attempt-2026-09-11.md`, `auth-watch.log`, `auth-watch.sh`, `BACKLOG.md`, `STATE.md`

## 🚀 Execution & Developer Quickstart
```bash
cd "C:/Users/asus/money-mission"
...
- **Audited by:** `gemini-3-5-flash` at `2026-09-14T11:12:01.551754+00:00`
