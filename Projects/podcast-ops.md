...
is_finished: false
tech_stack: ["Python"]
path: "C:/Users/asus/.workbuddy-ai/skills/podcast-ops"
git_remote: ""
git_branch: ""
git_dirty: false
last_commit: ""
...
> **Local Path:** `C:/Users/asus/.workbuddy-ai/skills/podcast-ops`
...
## 📂 Key Architecture
- **Sub-Modules:** Flat
- **Artifacts:** `podcast_pipeline.py`, `requirements.txt`, `SKILL.md`, `_skillhub_meta.json`

## 🚀 Developer Run & Next Steps
```bash
cd "C:/Users/asus/.workbuddy-ai/skills/podcast-ops"
python main.py
```
