...
> **Local Path:** `C:/Users/asus/rakazo`
...
- **Key Artifacts:** `docker-compose.images.yml`, `install-images.sh`, `install-run.log`, `pull-loop.log`, `self-host-restricted-network.md`

## 🚀 Execution & Developer Quickstart
```bash
cd "C:/Users/asus/rakazo"
...
- **Audited by:** `copilot-cli-adapter` at `2026-09-14T11:12:00.630169+00:00`
...
- **Workspace Diagnostics:**
  ...
  - Test Results: 2 passed, 0 failed (2 total, 0.54s)
