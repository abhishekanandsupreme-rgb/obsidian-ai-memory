...
is_finished: false
tech_stack: ["Python"]
path: "C:/Users/asus/.workbuddy-ai/skills/mcp-builder/scripts"
git_remote: "Local Only / Unpushed"
git_branch: ""
git_dirty: false
last_commit: ""
created_at: 2026-09-13
last_mapped: "2026-09-12 21:10:16"
tags:
  - project
  - project-unfinished
...
> **Local Path:** `C:/Users/asus/.workbuddy-ai/skills/mcp-builder/scripts`
...
## 📂 Key Architecture
- **Sub-Modules:** Flat
- **Artifacts:** `connections.py`, `evaluation.py`, `example_evaluation.xml`, `requirements.txt`

## 🚀 Developer Run & Next Steps
```bash
cd "C:/Users/asus/.workbuddy-ai/skills/mcp-builder/scripts"
python main.py
```
...
- **Audited by:** `gemini` at `2026-09-12T21:10:16.145737+00:00`
