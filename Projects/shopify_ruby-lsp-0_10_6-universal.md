---
title: "shopify.ruby-lsp-0.10.6-universal"
type: project
...
path: "C:/Users/asus/.antigravity-ide/extensions/shopify.ruby-lsp-0.10.6-universal"
git_remote: "Local Only / Unpushed"
git_branch: ""
git_dirty: false
last_commit: ""
created_at: 2026-09-13
last_mapped: "2026-09-12 21:40:16"
tags:
  - project
  - project-prototype
...
# shopify.ruby-lsp-0.10.6-universal

> **Category:** `Core User Repositories`
> **Lifecycle Status:** `Unfinished / In-Progress (WIP)` (Health Score: **65/100**)
> **Local Path:** `C:/Users/asus/.antigravity-ide/extensions/shopify.ruby-lsp-0.10.6-universal`
...
## 🧭 Overview & Mission
The Ruby LSP is an implementation of the [language server protocol](https://microsoft.github.io/language-server-protocol/) for Ruby, used to improve rich features in editors. ![Ruby LSP demo](https://github.com/Shopify/ruby-lsp/raw/HEAD/vscode/extras/ruby_lsp_demo.gif) The Ruby LSP features include - Semantic highlighting - Symbol search and code outline - RuboCop errors and warnings (diagnostics) - Format on save (with RuboCop or Syntax Tree) - Format on type - Debugging support - Running and d
...
## 📂 Key Architecture
- **Sub-Modules:** `grammars/`, `languages/`, `out/`
- **Artifacts:** `activation.rb`, `changelog.md`, `chruby_activation.rb`, `icon.png`, `LICENSE.txt`, `package.json`, `readme.md`, `snippets.json`

## 🚀 Developer Run & Next Steps
```bash
cd "C:/Users/asus/.antigravity-ide/extensions/shopify.ruby-lsp-0.10.6-universal"
npm run dev
```
...
- **Audited by:** `gemma3-local` at `2026-09-12T21:40:16.050756+00:00`
...
- **Workspace Diagnostics:**
  ...
  - Test Results: 0 passed, 1 failed (1 total, 21.8s)
