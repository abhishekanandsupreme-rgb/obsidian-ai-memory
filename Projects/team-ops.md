...
is_finished: false
tech_stack: ["Python"]
path: "C:/Users/asus/.workbuddy-ai/skills/team-ops"
git_remote: "Local Only / Unpushed"
git_branch: ""
git_dirty: false
last_commit: ""
created_at: 2026-09-13
last_mapped: "2026-09-12 21:11:11"
tags:
  - project
  - project-unfinished
...
> **Local Path:** `C:/Users/asus/.workbuddy-ai/skills/team-ops`
...
## 📂 Key Architecture
- **Sub-Modules:** Flat
- **Artifacts:** `meeting_action_extractor.py`, `requirements.txt`, `SKILL.md`, `team_performance_audit.py`, `_skillhub_meta.json`

## 🚀 Developer Run & Next Steps
```bash
cd "C:/Users/asus/.workbuddy-ai/skills/team-ops"
python main.py
```
...
- **Audited by:** `gemini` at `2026-09-12T21:11:11.967395+00:00`
