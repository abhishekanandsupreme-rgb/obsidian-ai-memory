...
is_finished: false
tech_stack: ["Python"]
path: "C:/Users/asus/.workbuddy-ai/skills/yt-competitive-analysis"
git_remote: "Local Only / Unpushed"
git_branch: ""
git_dirty: false
last_commit: ""
created_at: 2026-09-13
last_mapped: "2026-09-12 21:13:44"
tags:
  - project
  - project-unfinished
...
> **Local Path:** `C:/Users/asus/.workbuddy-ai/skills/yt-competitive-analysis`
...
## 📂 Key Architecture
- **Sub-Modules:** Flat
- **Artifacts:** `analyze.py`, `requirements.txt`, `SKILL.md`, `_skillhub_meta.json`

## 🚀 Developer Run & Next Steps
```bash
cd "C:/Users/asus/.workbuddy-ai/skills/yt-competitive-analysis"
python main.py
```
...
- **Audited by:** `gemini` at `2026-09-12T21:13:44.361473+00:00`
